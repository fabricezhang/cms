...
<div class="container">
    ...
    <c:if test="${empty articleList}">
        <div class="alert alert-warning" role="alert">
            <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>No Article Found，Please  <a href="/admin/articles/add" type="button" class="btn btn-primary btn-sm">Add Article</a>
        </div>
    </c:if>
